                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1 pr-4">
                      ...
                      <p className="mt-1 text-sm text-gray-500 dark:text-gray-400 ml-7">Voters can select more than one option.</p>
                    </div>
                    <div className="flex items-center h-6">
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" className="sr-only peer" checked={allowMultiple} onChange={() => setAllowMultiple(!allowMultiple)} />
